...
Функция ПолучитьСписокТестов(Тестирование) Экспорт
	...
	СписокТестов.Добавить("Тест_СписокБаз");
	СписокТестов.Добавить("Тест_СписокБазИГрупп");
...
Процедура Тест_СписокБаз() Экспорт
	
	Парсер = Новый ПарсерСпискаБаз;
	Парсер.УстановитьФайл("tests/ibases.v8i");
	СписокБаз = Парсер.ПолучитьСписокБаз(Истина);
	
	ПапкаНайденаМоиУчебные = СписокБаз.Получить("Мои=учебные");
	Ожидаем.Что(ПапкаНайденаМоиУчебные).ЭтоНеопределено();
	
КонецПроцедуры

Процедура Тест_СписокБазИГрупп() Экспорт
	...
	ПапкаНайденаМоиУчебные = СписокБаз.Получить("Мои=учебные");
	Ожидаем.Что(ПапкаНайденаМоиУчебные).Существует();
